		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App List",
									"targetURL": "#logaliapplist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaliapplist-display": {
								"semanticObject": "logaliapplist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logali.applist",
									"url": sap.ui.require.toUrl("logali/applist")
								}
							}
						}
					}
